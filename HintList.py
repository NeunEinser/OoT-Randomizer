...
hintTable = {
    ...
    'Chicken':                                                  (["the Chicken"],"the Chicken",'item'),
    'Zeldas Letter':                                            (["an autograph", "royal stationery", "royal snail mail"], "Zelda's Letter", 'item'),
    'Keaton Mask':                                              (["the Keaton Mask"],"the Keaton Mask",'item'),
    'Skull Mask':                                               (["the Skull Mask"],"the Skull Mask",'item'),
    'Spooky Mask':                                              (["the Spooky Mask"],"the Spooky Mask",'item'),
    'Bunny Hood':                                               (["the Bunny Hood"],"the Bunny Hood",'item'),
    'Goron Mask':                                               (["the Goron Mask"],"the Goron Mask",'item'),
    'Zora Mask':                                                (["the Zora Mask"],"the Zora Mask",'item'),
    'Gerudo Mask':                                              (["the Gerudo Mask"],"the Gerudo Mask",'item'),
    'Mask of Truth':                                            (["the Mask of Truth"],"the Mask of Truth",'item'),
